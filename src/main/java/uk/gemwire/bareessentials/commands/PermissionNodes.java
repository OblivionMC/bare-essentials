...
public class PermissionNodes {
    ...
    public static final PermissionNode<Boolean> REPAIR = new PermissionNode<>(MODID, "cmd.repair",
        PermissionTypes.BOOLEAN, (player, uuid, contexts) -> player != null && Commands.hasPermission(Commands.LEVEL_GAMEMASTERS).test().check(player.permissions()));
    ...
    public static final PermissionNode<Boolean> BANK = new PermissionNode<>(MODID, "cmd.bank",
        PermissionTypes.BOOLEAN, (player, uuid, contexts) -> player != null && Commands.hasPermission(Commands.LEVEL_ALL).test().check(player.permissions()));
